...
<template>
  <section class="px-4 py-5">
    <div class="space-y-6 rounded bg-white px-7 py-5">
      ...
      >
        <table
          class="w-full text-dark-shade-01"
          :table-data="tableData"
        >
          <thead
            class="border-b border-b-dark-gray-05 text-left text-xs font-bold"
          >
            <tr>
              ...
              <th class="py-2">{{ tableData.method }}</th>
            </tr>
          </thead>
          <tbody class="text-xs">
            <tr
            ...
            >
              ...
              >
                <button
                  class="rounded border border-light-gray-03 p-1 text-green-dark"
                >
                  <CheckIcon class="h-3 w-3" />
                </button>

                <button
                  class="rounded border border-light-gray-03 p-1 text-red-dark"
                >
